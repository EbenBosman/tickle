...
4. **How is it tested?** What unit / integration / contract tests cover it, and what is deliberately *not* tested (and why).
...
2. **Read the existing spec** at `docs/specs/<module>.md` if one exists. If it does, you are *updating* — preserve the structure, change only what's drifted.
